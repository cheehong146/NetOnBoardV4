...
import com.example.netonboard.netonboardv4.Adapter.ServerDownAdapter;
import com.example.netonboard.netonboardv4.Object.GlobalFileIO;
import com.example.netonboard.netonboardv4.Object.ServerDown;
...
public class SupportServerDown extends Fragment {
    ...
    public void loadServerDown() {
        ...
        runnableServerDown = new Runnable() {
            @Override
            public void run() {
                String body = fileIO.readFile(fileIO.getFILENAMEDOWN());
                try {
                    if(!body.equals("")) {
