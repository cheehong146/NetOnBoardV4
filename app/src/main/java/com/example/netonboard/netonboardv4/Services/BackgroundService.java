package com.example.netonboard.netonboardv4.Services;
...
import com.example.netonboard.netonboardv4.Activity.NotificationActivity;
...
//        fileDown = new File(getApplicationContext().getFilesDir(), fileIO.getFILENAMEDOWN());
//        fileHistory = new File(getApplicationContext().getFilesDir(), fileIO.getFILENAMEHISTORY());
//        fileSupport = new File(getApplicationContext().getFilesDir(), fileIO.getFILENAMESUPPORT());
//        fileNotifyTime = new File(getApplicationContext().getFilesDir(), fileIO.getFILENAMENOTIFYTIME());
        fileRemark = new File(getApplicationContext().getFilesDir(), fileIO.getFILENAMEREMARK());
    ...
    public void loadSupport() {
        ...
        try {
            ...
            fileIO.writeToFile(fileIO.getFILENAMESUPPORT(), body);
//            Log.i(TAG, "Written sP");
    ...
    public void loadServerDownList() {
        ...
        try {
            String body = client.newCall(request).execute().body().string();
            fileIO.writeToFile(fileIO.getFILENAMEDOWN(), body);
            try {
                if (!body.equals("")) {
...
//            Log.i(TAG, "Written sDown");
    ...
    public void LoadErrorHistory() {
        ...
        try {
            String body = client.newCall(request).execute().body().string();
            fileIO.writeToFile(fileIO.getFILENAMEHISTORY(), body);
