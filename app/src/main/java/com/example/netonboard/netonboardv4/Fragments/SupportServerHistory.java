package com.example.netonboard.netonboardv4.Fragments;
...
import com.example.netonboard.netonboardv4.Adapter.ServerHistoryAdapter;
import com.example.netonboard.netonboardv4.Object.GlobalFileIO;
import com.example.netonboard.netonboardv4.Object.ServerHistory;
...
//            table_history.setElevation(10);
    ...
    public void loadServerHistory() {
        ...
        runnableServerHistory = new Runnable() {
            @Override
            public void run() {
                String body = fileIO.readFile(fileIO.getFILENAMEHISTORY());
                JSONObject jObj;
                JSONArray jArray;
